...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [[object valueForKey:@"dates"] description];
}
...
- (IBAction)addItem:(id)sender {
    ...
    [newManagedObject setValue:[NSDate date] forKey:@"dates"];
...
- (IBAction)addDay:(id)sender {
    ...
    // I know there's duplicate code here but
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"dates" ascending:NO];
